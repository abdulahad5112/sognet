//! This module provides the functionality to handle different routes of the `sognet`
...
/// Handles the route of index page or main page of the `sognet` meta search engine website.
#[get("/")]
pub async fn index(
...
/// Handles the route of search page of the `sognet` meta search engine website and it takes
...
/// Handles the route of robots.txt page of the `sognet` meta search engine website.
#[get("/robots.txt")]
...
/// Handles the route of about page of the `sognet` meta search engine website.
#[get("/about")]
pub async fn about(
    hbs: web::Data<Handlebars<'_>>,
    config: web::Data<Config>,
...
/// Handles the route of settings page of the `sognet` meta search engine website.
#[get("/settings")]
